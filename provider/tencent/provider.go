...
func (tencent *Tencent) buildGFuncInvokeReq(funcName string, projectId string, qParams *url.Values, headers *http.Header, body *[]byte) (*http.Request, error) {
	...
	//funcUrl.Host = "service-8fzsuuln-1256474564.sh.apigw.tencentcs.com"
	//funcUrl.Path = "sleep"
	...
	funcUrl.Host = "service-cxvb2r3h-1256474564.sh.apigw.tencentcs.com"
	funcUrl.Path = "iostresslvl1"
